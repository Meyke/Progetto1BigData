...
public class TestJob3 {
	...
	public void testMapperHistoricalStockPrice() throws Exception {
		...
		mp = mp.withMapper(new Job2Mapper3());
		...
		mp.withInput(new LongWritable(1), new Text("AHH" + "\t" + "11.5,11.5799999237061,4633900,2017-05-08,dfsdf"));
		System.out.println(mp.run().toString());
		System.out.println("\n");
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");  
	    Calendar calendar = new GregorianCalendar();
	    try { 
	    	Date date = formatter.parse("2017-11-08");
...
//		Text stock30 = new Text("stockprice,WAT,215.6100006o10352,2018-01-31");
//
//
